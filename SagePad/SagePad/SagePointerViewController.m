...
@implementation SagePointerViewController 
...
- (void)viewDidLoad {
    ...
    NSLog(@"SagePointerViewController: about to call networkingService.startServer");
    [networkingService startServer];
    NSLog(@"SagePointerViewController: networkingService.startServer returned");
